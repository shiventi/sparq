...
stream = client.chat.completions.create(
    messages=[
        {
            "role": "system",
            "content": """You are a JSON converter.
...
"""
        ...
        {
            "role": "user",
            "content": """African American Studies
...
for chunk in stream:
    ...
    if content:
        ...
        print(content, end="")  # Optional: print to console

# Join all chunks into a single string for the full output
...
output_data = {
    "output": parsed_output  # Store as parsed object, not raw string
}

# Write the clean JSON data to a file with pretty formatting
...
URL = "https://transfer.sjsu.edu/web-dbgen/artic/ANTELOPE/course-to-course.html"
...
for i in range(0,len(course_to_course)):
    if "valign=" in str(course_to_course[i]):
        start_value = i
        break
